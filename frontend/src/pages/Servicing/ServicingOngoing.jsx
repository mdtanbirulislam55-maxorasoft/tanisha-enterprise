...
const ServicingOngoing = () => {
  ...
  const IconComponent = iconMap["Wrench"] || AlertCircle;
  ...
  return (
    <div className={`p-6 ${theme === 'dark' ? 'text-white' : 'text-gray-900'}`}>
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          <h1 className="text-2xl font-bold">Ongoing Services</h1>
          <p className={`${theme === 'dark' ? 'text-gray-400' : 'text-gray-600'}`}>
            Active service jobs in progress
          </p>
        </div>
      </div>
      ...
      <div className={`rounded-xl p-8 text-center ${theme === 'dark' ? 'bg-gray-800/50' : 'bg-gray-100'}`}>
        ...
        <h2 className="text-2xl font-bold mb-4">Ongoing Services</h2>
...
export default ServicingOngoing;
